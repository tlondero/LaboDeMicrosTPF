...
#define AUDIO_PDB_MODULUS_VALUE      0x21U
...
#define AUDIO_PDB_DAC_INTERVAL_VALUE 0x21U
...
static void PDB_Configuration(void)
{
    ...
    PDB_SetModulusValue(DEMO_PDB_BASEADDR, AUDIO_PDB_MODULUS_VALUE);
    ...
    PDB_SetDACTriggerIntervalValue(DEMO_PDB_BASEADDR, DEMO_PDB_DAC_CHANNEL, AUDIO_PDB_DAC_INTERVAL_VALUE);
