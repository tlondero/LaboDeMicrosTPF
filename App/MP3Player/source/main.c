...
static uint8_t aniMatrix[8][8*7];
/**********************************************************************************************
 *                                         MAIN                                               *
 **********************************************************************************************/
...
void initAnimation(void){
	...
	//Squiggly_1
	aniMatrix[3][7+8*5] = ANIM_GREEN;
	aniMatrix[4][6+8*5] = ANIM_GREEN;
	aniMatrix[5][5+8*5] = ANIM_GREEN;
	aniMatrix[4][4+8*5] = ANIM_GREEN;
	aniMatrix[3][3+8*5] = ANIM_GREEN;
	aniMatrix[2][2+8*5] = ANIM_GREEN;
	aniMatrix[3][1+8*5] = ANIM_GREEN;
	aniMatrix[4][0+8*5] = ANIM_GREEN;
	...
	//Squiggly_2
	aniMatrix[4][7+8*0] = ANIM_GREEN;
	aniMatrix[3][6+8*0] = ANIM_GREEN;
	aniMatrix[2][5+8*0] = ANIM_GREEN;
	aniMatrix[3][4+8*0] = ANIM_GREEN;
	aniMatrix[4][3+8*0] = ANIM_GREEN;
	aniMatrix[5][2+8*0] = ANIM_GREEN;
	aniMatrix[4][1+8*0] = ANIM_GREEN;
	aniMatrix[3][0+8*0] = ANIM_GREEN;
